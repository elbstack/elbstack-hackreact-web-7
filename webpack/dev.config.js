...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      { test: /\.less$/, loader: 'style!css?reducers&importLoaders=2&sourceMap&localIdentName=[local]___[hash:base64:5]!autoprefixer?browsers=last 2 version!less?outputStyle=expanded&sourceMap' },
      { test: /(\.scss|\.css)$/, loader: 'style!css?reducers&modules&importLoaders=2&sourceMap&localIdentName=[local]___[hash:base64:5]!autoprefixer?browsers=last 2 version!resolve-url!sass?outputStyle=expanded&sourceMap!' },
